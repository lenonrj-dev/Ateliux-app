...
export function NewsroomHero({ title, description }: NewsroomHeroProps) {
  return (
    <section className="relative mx-auto w-full overflow-hidden rounded-[42px] bg-[#0b0b0f] px-10 py-16 text-center shadow-[0_30px_90px_-70px_rgba(0,0,0,0.8)] md:px-16 md:py-20">
