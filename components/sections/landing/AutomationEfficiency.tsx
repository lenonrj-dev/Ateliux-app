    ...
    <section className="relative isolate overflow-hidden bg-[#020308] px-6 py-20 lg:px-8">
      <LazyMotion features={domAnimation}>
        <m.div
          ...
          className="relative mx-auto flex max-w-6xl flex-col gap-16"
        >
          <div className="grid items-center gap-10 md:grid-cols-2 md:gap-12">
            <m.div
              ...
              className="mx-auto w-full max-w-[520px] rounded-3xl bg-white/[0.03] p-3 shadow-[0_30px_90px_-60px_rgba(0,0,0,0.8)]"
            >
              <Image
            ...
            <div className="mx-auto max-w-[520px] space-y-4 text-left">
              <m.p variants={itemFadeUp} className="text-xs font-semibold uppercase tracking-[0.26em] text-primary">
                Automatize tarefas
              </m.p>
