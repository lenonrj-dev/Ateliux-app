    ...
    <section className="relative isolate overflow-hidden bg-[#020308] px-6 py-14 lg:px-8">
      <LazyMotion features={domAnimation}>
        ...
        >
          <m.p
            variants={itemFadeUp}
            className="text-xs font-semibold uppercase tracking-[0.3em] text-slate-300/80"
          >
            Portfolio Ateliux
          </m.p>
          <m.div variants={itemFadeUp} className="logos-marquee w-full overflow-hidden">
              ...
              {[...items, ...items, ...items].map((item, index) => {
                ...
                return (
                  <div
                    ...
                    className={`mt-2 flex min-w-[150px] items-center justify-center gap-2 rounded-full px-3 py-2 text-sm transition ${
                      isHighlight
